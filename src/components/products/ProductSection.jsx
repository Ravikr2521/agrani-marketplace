...
function MiniProductCard({ product, variant }) {
  ...
  return (
    <>
      <Card className="group overflow-hidden rounded-2xl border border-border/70 bg-white shadow-xs transition-all duration-300 hover:shadow-sm">
        <button
          type="button"
        ...
        >
          <div className="relative overflow-hidden">
            ...
            <div className="absolute right-2 top-2 z-10 rounded-full border border-orange-200 bg-white/95 px-2 py-1 text-[9px] font-semibold text-orange-600 shadow-sm">
        ...
        <div className="p-2.5">
          <div className="flex justify-between gap-2">
            <button
              type="button"
              onClick={openProductDetails}
              className="block min-w-0 truncate text-left text-[13px] font-bold leading-tight text-body-dark"
            >
              {product?.name}
            </button>
            ...
            <Link
              ...
              className="mt-0.5 flex min-w-0 shrink-0 items-center gap-1 truncate text-[10px] text-muted"
            >
          ...
          <div className="mt-1 flex min-w-0 gap-1 truncate text-[10px] font-medium">
          ...
          <div className="mt-2.5 flex items-center justify-between gap-2">
            <div className="min-w-0">
              <div className="text-[16px] font-bold leading-none tracking-tight text-body-dark">
            ...
            {quantity > 0 ? (
              <div
                className="flex h-7 shrink-0 items-center overflow-hidden rounded-lg border border-orange-200 bg-orange-50"
                onClick={(event) => {
                  event.preventDefault();
                  event.stopPropagation();
                }}
              >
                <button
                  ...
                  className="grid h-7 w-7 place-items-center text-orange-600 transition hover:bg-orange-100 active:bg-orange-200"
                  aria-label={`Decrease ${product?.name} quantity`}
                >
                  <span className="text-lg font-semibold leading-none">−</span>
                </button>

                <span className="min-w-7 text-center text-sm font-bold text-body-dark">
                  {quantity}
                </span>
                ...
                <button
                  ...
                  className="grid h-7 w-7 place-items-center text-orange-600 transition hover:bg-orange-100 active:bg-orange-200 disabled:cursor-not-allowed disabled:opacity-40"
          ...
          <div className="min-w-0">
            {title && (
              <div className="flex items-center gap-2.5">
                ...
                <h2 className="truncate text-lg font-bold tracking-tight text-body-dark sm:text-2xl">
                  {title}
                </h2>
              </div>
            )}
